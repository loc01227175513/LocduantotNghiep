export const Dashboard = async () => {
    ...
    const url = 'http://huuphuoc.id.vn/api/kiemtragiangvien';
...
export const GiangvienKhoaHoc = async () => {
    ...
    const url = 'http://huuphuoc.id.vn/api/laykhoahocdanglam';
...
export const GiangvienKhoaHocDaMua = async () => {
    const userData = localStorage.getItem('lecturerId');
    const parsedLecturer = JSON.parse(userData);
    const url = 'http://huuphuoc.id.vn/api/TongSoDangKy';
...
export const GiangvienDoanhThu = async () => {
    const userData = localStorage.getItem('lecturerId');
    const parsedLecturer = JSON.parse(userData);
    const url = 'http://huuphuoc.id.vn/api/DoanhThuGiangVien';
