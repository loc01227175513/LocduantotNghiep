export const KhoaHocYeuThich = async (id) => {
    const url = 'http://huuphuoc.id.vn/api/addKhoaHocYeuThich';
...
export const DanhSachYeuThich = async () => {
    ...
    const url = 'http://huuphuoc.id.vn/api/showKhoaHocYeuThich'
    const response = await fetch(url, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
...
export const XoaKhoaHocYeuThich = async (id) => {
    const url = `http://huuphuoc.id.vn/api/deleteKhoaHocYeuThich/${id}`;
    try {
      const response = await fetch(url, {
        method: 'DELETE',
      });
