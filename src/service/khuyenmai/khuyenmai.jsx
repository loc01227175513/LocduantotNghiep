export const AddKhuyenMaiKhoaHoc = async (selectedCoupon) => {
    const url = 'http://huuphuoc.id.vn/api/addMaGiamGiaKhoaHoc';
...
export const TatCaKhuyenMaiKhoaHoc = async () => {
    const url = 'http://huuphuoc.id.vn/api/showAllMaGiamGiaKhoaHoc';
    try {
        const response = await fetch(url);
        if (!response.ok) {
...
export const TatCaKhuyenMai = async () => {
    const url = 'http://huuphuoc.id.vn/api/showAllMaGiamGia';
    try {
        const response = await fetch(url);
        if (!response.ok) {
            throw new Error('Failed to fetch MaGiamGia data');
...
export const NguoiDungMaGiamGia = async (DataCoupon) => {
    const url = 'http://huuphuoc.id.vn/api/addNguoiDungMaGiamGia';
...
export const showAllNguoiDungMaGiamGia = async () => {
    ...
    const url = 'http://huuphuoc.id.vn/api/showAllNguoiDungMaGiamGia';
    try {
        const response = await fetch(url, {
            method: 'POST',
            headers: {
...
export const TinhMaGiamGia = async () => {
    const url = "http://huuphuoc.id.vn/api/TinhMaGiamGia";
    const userData = localStorage.getItem('data');
