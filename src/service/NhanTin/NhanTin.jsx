export const DanhSachTinNhan = async () => {
    ...
    const url = 'http://huuphuoc.id.vn/api/showAllNhanTin';
...
export const NguoiDungTinNhan = async () => {
    ...
    const url = 'http://huuphuoc.id.vn/api/laynguoidung';
    const response = await fetch(url, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
...
export const showGiangVien = async () => {
    ...
    const url = `http://huuphuoc.id.vn/api/giangvien`;
    const response = await fetch(url, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
...
export const DanhSachTinNhanGiangVien = async () => {
    ...
    const url = process.env.REACT_APP_API_URL || 'http://huuphuoc.id.vn/api/showAllNhanTinGiangVien';
    try {
        const response = await fetch(url, {
            method: 'POST',
            headers: {
...
export const ShowAllNguoiDung = async () => {
    const url = 'http://huuphuoc.id.vn/api/showAllNguoiDung';
    try {
        const response = await fetch(url, {
            method: 'GET',
            headers: {
...
export const GiangVienHientai = async () => {
    ...
    const url = 'http://huuphuoc.id.vn/api/giangVienHientai';
    const response = await fetch(url, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
