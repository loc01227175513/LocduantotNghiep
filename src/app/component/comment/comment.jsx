                ...
                {displayedComments.map((item, index) => (
                    <div key={index} className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-shadow duration-300">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h6 className="font-semibold text-2xl mb-2">{item.nguoi_danh_gia.ten}</h6>
                                <span className="px-3 py-1 bg-pink-200 rounded-full text-pink-700 text-lg text-center mt-2">
                                    Học viên
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="mt-4">
                            ...
                            <button className="text-pink-500 hover:text-pink-700 text-lg font-medium mt-2 transition-colors duration-200">
                                Xem tiếp →
                            </button>
                        </div>
