    ...
    <div className="h-auto border category-area-style-one shape-move rts-section-gap bg_image">
      ...
      <div className="shape-image">
        <div className="shape one" data-speed="0.04" data-revert="true">
          {/* <Image width={500} height={300}    src="assets/images/banner/15.png" alt="" /> */}
        </div>
        <div className="shape two" data-speed="0.04">
          {/* <Image width={500} height={300}    src="assets/images/banner/shape/banner-shape02.svg" alt="" /> */}
        </div>
        <div className="shape three" data-speed="0.04">
          {/* <Image width={500} height={300}    src="assets/images/banner/shape/banner-shape03.svg" alt="" /> */}
        </div>
      </div>
    </div>
  );
