...
export default function Header() {
  ...
  return (
    <>
      ...
      {isopensearch && (
        <div className="input-search fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="div-input flex flex-col items-center bg-white p-6 rounded-xl shadow-2xl">
            <form onSubmit={FormSearch} className="flex w-full">
              <div className="flex border-2 border-gray-300 rounded-md w-full focus-within:border-blue-500 transition duration-200">
                <input
                  type="text"
                  placeholder="Tìm kiếm"
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="flex-grow p-2 focus:outline-none rounded-l-md focus:ring-2 focus:ring-blue-500 transition duration-200"
                />
                <button
                  type="submit"
                  className="bg-blue-500 p-2 text-white rounded-r-md hover:bg-blue-600 transition duration-200"
                >
                  Search
                </button>
              </div>
