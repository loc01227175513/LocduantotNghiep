              ...
              <div className="col-12">
                <div className="call-to-sction bg_image shape-move">
                  ...
                  <div className="cta-image">
                    {/* <Image width={500} height={300}    src="assets/images/cta/women.png" alt="" /> */}
                  </div>
                  <div className="shape-image">
                    <div className="shape one" data-speed="0.04">
                      {/* <Image width={500} height={300}    src="assets/images/cta/03.svg" alt="" /> */}
                    </div>
                    <div className="shape two" data-speed="0.04">
                      {/* <Image width={500} height={300}    src="assets/images/cta/04.svg" alt="" /> */}
                    </div>
                  </div>
                </div>
              </div>
