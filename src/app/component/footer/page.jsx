        ...
        <div className="container mx-auto px-4">
          ...
          <div className="bg-gradient-to-r from-gray-900 via-pink-700 to-gray-600 rounded-2xl p-12 relative overflow-hidden">
            <div className="max-w-2xl relative z-10">
             ...
             Mở khóa tiềm năng của bạn với<br />
                <span className="text-white-300 text-4xl mt-20">TechStudent Chứng nhận</span>
              </h2>
              <a href="/page/Cours-Filter" className="inline-flex items-center px-6 py-3 bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition duration-300 text-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
            ...
            <div>
              ...
              Trao quyền cho người học trên toàn thế giới với các tài nguyên giáo dục chất lượng cao và công nghệ tiên tiến.
              </p>
              <div className="space-y-3">
                <a href="#" className="flex items-center text-gray-600 hover:text-blue-600 text-xl">
             ...
             Melbourne, Úc
                ...
                <a href="tel:+61485826710" className="flex items-center text-gray-600 hover:text-blue-600 text-xl">
                  <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="/courses" className="text-gray-600 hover:text-blue-600 text-xl">Các khóa học mới nhất</a></li>
                <li><a href="/about" className="text-gray-600 hover:text-blue-600 text-xl">Về chúng tôi</a></li>
                <li><a href="/careers" className="text-gray-600 hover:text-blue-600 text-xl">Sự nghiệp</a></li>
                <li><a href="/pricing" className="text-gray-600 hover:text-blue-600 text-xl">Kế hoạch định giá</a></li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <form className="space-y-4">
                <div className="flex max-w-md">
                  ...
                  <button 
                    type="submit" 
                    className="px-6 py-3 bg-blue-600 text-white rounded-r-lg hover:bg-blue-700 transition duration-300 text-xl"
                  >
                  Gửi
                  </button>
                </div>
