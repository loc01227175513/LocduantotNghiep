    ...
    <div className="container mx-auto mt-60">
      <div className="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen py-16 px-4">
        <div className="mx-auto">
          {/* Animated Header */}
          <h1 className="text-6xl font-semibold mb-16 text-center animate-fade-in relative">
            ...
            <div className="flex flex-row gap-20 justify-center">
              ...
              <div className="w-full lg:w-1/3 space-y-8">
                <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-shadow duration-300">
                  <h2 className="text-3xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-pink-700 to-gray-600">
                      ...
                      item.khoahocs.map((khoahoc) => (
                        ...
                        >
                          ...
                          <div className="flex-grow ml-8">
                            <h3 className="text-3xl font-bold text-gray-800 mb-3 hover:text-purple-600 transition-colors">
                              {khoahoc.ten}
                            </h3>
                            ...
                            <div className="flex items-center">
                              ...
                              <p className="text-gray-500 line-through ml-4 text-3xl">
                                {khoahoc.gia}
                                <span className="text-2xl">VNĐ</span>{" "}
                              </p>
                            </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center pb-4">
                      ...
                      <span className="text-2xl font-bold text-gray-800">
                        {totalPrice.toFixed(2)}<span className="text-xl">VNĐ</span>
                      </span>
                    </div>
                    <div className="flex justify-between items-center pb-4">
              ...
              <div className="w-full lg:w-1/3 space-y-8">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-shadow duration-300 border border-purple-100">
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-6">
                    <div className="mb-4">
                      <label className="font-medium text-gray-700 text-2xl pb-4">
                        Chọn phương thức
                      </label>
                      ...
                      <div className="flex items-center mb-2 p-2">
                        ...
                        <label htmlFor="vehicle1">
                          <span className="text-xl" style={{ fontSize: "14px" }}>Thanh toán Momo</span>
                        </label>
                      </div>
                      ...
                      <div className="flex items-center mb-2 p-2">
                        ...
                        <label htmlFor="vehicle2">
                          <span className="text-xl" style={{ fontSize: "14px" }}>Thanh toán VNPAY</span>
                        </label>
                      </div>
                      ...
                      <div className="flex items-center mb-2 p-2">
                        <input
                          ...
                          value="ATM"
                          checked
                          className="mr-2 text-xl" style={{ fontSize: "14px" }}
                        />
                        <label htmlFor="vehicle3">
                          <span className="text-xl" style={{ fontSize: "14px" }}>Thanh toán ATM</span>
                        </label>
                      </div>
                    </div>
                    ...
                    <button
                      type="submit"
                      className="w-full text-3xl font-bold mb-8 bg-gradient-to-r from-gray-900 via-pink-700 to-gray-600 text-white py-4 rounded-lg font-bold text-lg hover:from-purple-700 hover:to-purple-800 transition-all transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
                      style={{ fontSize: "14px" }}
                    >
                      Thanh Toán
                      {(totalPrice - (totalPrice * discount) / 100).toFixed(
