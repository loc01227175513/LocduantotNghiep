    ...
    return (
        <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="mt-8 flex justify-center">
                <Image width={500} height={300}    src="https://cdn.vus.edu.vn/webroot/css/images/website/2024/giaovien/ANNE-KENTHILL-ELOISE.webp" alt="instructor" className="w-96 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300" />
            </div>
        </div>
    );
};
...
const InstructorRules = () => {
    return (
        <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="mt-8 flex justify-center">
                <Image width={500} height={300}    src="https://cdn.vus.edu.vn/webroot/css/images/website/2024/giaovien/EMILIE-SLATER.webp" alt="instructor" className="w-96 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300" />
            </div>
        </div>
    );
};
...
const StartWithCourses = () => {
    return (
        <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="mt-8 flex justify-center">
                <Image width={500} height={300}    src="https://cdn.vus.edu.vn/webroot/css/images/website/2024/giaovien/ARMANDO-DE-CRESCENZO.webp" alt="instructor" className="w-96 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300" />
            </div>
        </div>
    );
};
    ...
    return (
        <>
            ...
            <div className="p-8 bg-gray-100 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className="mb-16">
                    <Image width={500} height={300}    src="https://cdn.vus.edu.vn/webroot/css/images/website/2024/banner_inside/banner_giaovien.webp" alt="instructor" className="w-full rounded-xl shadow-md transform hover:scale-105 transition-transform duration-300" />
                </div>
            </div>
