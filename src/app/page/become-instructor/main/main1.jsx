...
const BecomeInstructor = () => {
    return (
        <div className="relative p-8 bg-gradient-to-br from-white to-pink-100 rounded-xl shadow-lg 
            ...
            <div className="relative z-10">
                <div className="flex items-center mb-8">
                    ...
                    <p className="text-[20px] text-gray-700 border-l-4 border-blue-500 pl-4 italic">
                ...
                <div className="space-y-8">
                    <div className="transform hover:scale-102 transition-all p-4 bg-white rounded-lg shadow-sm">
                        <h6 className="mb-3 text-[20px] font-bold text-black flex items-center">
                            <i className="fas fa-lightbulb text-yellow-400 mr-2"></i>
                            Xác định lĩnh vực chuyên môn của bạn:
                        </h6>
                        <p className="text-gray-700 ml-6 text-[16px]">
...
const InstructorRules = () => {
    return (
        <div className="relative p-8 bg-gradient-to-br from-white to-pink-100 rounded-xl shadow-lg 
            ...
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-pink-100 rounded-full -mr-16 -mt-16 opacity-20"/>
            ...
            <div className="relative z-10">
                ...
                <div className="space-y-6">
                    <div className="transform hover:scale-102 transition-all p-6 bg-white rounded-lg shadow-sm border-l-4 border-yellow-400">
                        ...
                        <p className="text-gray-700 ml-8 text-[16px]">
                            Xác định môn học hoặc kỹ năng mà bạn có chuyên môn và đam mê giảng dạy.
                        </p>
                    </div>
...
const StartWithCourses = () => {
    return (
        <div className="relative p-8 bg-gradient-to-br from-white to-pink-100 rounded-xl shadow-lg 
            ...
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-pink-100 rounded-full -ml-16 -mb-16 opacity-20"/>
            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center mb-8 bg-white p-6 rounded-lg shadow-sm border-l-4 border-indigo-500">
                    ...
                    <p className="text-[20px] text-gray-700 pl-4">
                        Trở thành một người hướng dẫn liên quan đến một loạt các bước có thể thay đổi tùy thuộc vào loại hướng dẫn mà bạn quan tâm (ví dụ: giảng dạy học thuật, đào tạo công ty, khóa học trực tuyến). Đây là một hướng dẫn chung để giúp bạn trở thành một người hướng dẫn:
                    </p>
                </div>
                ...
                <div className="space-y-6">
                    <div className="transform hover:scale-102 transition-all p-6 bg-white rounded-lg shadow-sm hover:shadow-md">
                        <h6 className="mb-3 text-[20px] font-bold text-black flex items-center">
                            <i className="fas fa-compass text-yellow-500 mr-3 text-[20px]"></i>
                            Xác định lĩnh vực chuyên môn của bạn:
                        </h6>
                        <p className="text-gray-700 ml-8 text-[16px]">
                            Xác định môn học hoặc kỹ năng mà bạn có chuyên môn và đam mê giảng dạy.
                    ...
                    <div className="transform hover:scale-102 transition-all p-6 bg-white rounded-lg shadow-sm hover:shadow-md">
                        <h6 className="mb-3 text-[20px] font-bold text-black flex items-center">
                            <i className="fas fa-graduation-cap text-indigo-500 mr-3 text-[20px]"></i>
                            Trình độ học vấn:
                        </h6>
                        <p className="text-gray-700 ml-8 text-[16px]">
                            Có được các bằng cấp giáo dục cần thiết cho cấp độ và loại hướng dẫn mà bạn đang hướng tới. Điều này có thể bao gồm bằng cử nhân.
...
export default function Main1() {
    ...
    return (
        <>
            ...
            <div className="p-8 bg-gradient-to-r from-blue-900 to-pink-700 via-pink-700 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
                <div className="mb-16 relative">
                    ...
                    <h2 className="mb-6 text-[24px] font-bold text-white">Làm thế nào để trở thành một người hướng dẫn</h2>
                    <p className="text-white text-[20px] opacity-90">
                ...
                <ul className="flex border-b-2  border-gray-200 gap-2">
                    {[
                        ...
                        <li key={tab.id}>
                            <button
                                className={`
                                    inline-block px-8 py-4  font-semibold rounded-t-lg
                                    transition-all duration-300 transform hover:-translate-y-1 text-[16px]
                                    ${activeTab === tab.id 
                                        ? 'text-black border-b-4 border-pink-700 bg-white shadow-lg' 
