                  ...
                  >
                    <div className="row g-5 mt--10">
                      <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        ...
                        <div className="rts-single-course">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/01.jpg" alt="course" />
                          </a>
                          <div
                            className="save-icon"
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        ...
                        <div className="rts-single-course">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/02.jpg" alt="course" />
                          </a>
                          <div
                            className="save-icon"
                            data-bs-toggle="modal"
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        ...
                        <div className="rts-single-course">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/03.jpg" alt="course" />
                          </a>
                          <div
                            className="save-icon"
                            data-bs-toggle="modal"
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        ...
                        <div className="rts-single-course">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/04.jpg" alt="course" />
                          </a>
                          <div
                            className="save-icon"
                            data-bs-toggle="modal"
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        ...
                        <div className="rts-single-course">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/05.jpg" alt="course" />
                          </a>
                          <div
                            className="save-icon"
                            data-bs-toggle="modal"
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        ...
                        <div className="rts-single-course">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/06.jpg" alt="course" />
                          </a>
                          <div
                            className="save-icon"
                            data-bs-toggle="modal"
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        ...
                        <div className="rts-single-course">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/07.jpg" alt="course" />
                          </a>
                          <div
                            className="save-icon"
                            data-bs-toggle="modal"
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        ...
                        <div className="rts-single-course">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/08.jpg" alt="course" />
                          </a>
                          <div
                            className="save-icon"
                            data-bs-toggle="modal"
                    ...
                    <div className="row g-5 mt--30">
                      <div className="col-lg-12">
                        ...
                        <div className="rts-single-course course-list">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/11.jpg" alt="course" />
                          </a>
                        ...
                        <div className="rts-single-course course-list">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/12.jpg" alt="course" />
                          </a>
                          <div className="information-inner">
                            <div className="tags-area-wrapper">
                              <div className="single-tag">
                        ...
                        <div className="rts-single-course course-list">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/13.jpg" alt="course" />
                          </a>
                          <div className="information-inner">
                            <div className="tags-area-wrapper">
                              <div className="single-tag">
                        ...
                        <div className="rts-single-course course-list">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/14.jpg" alt="course" />
                          </a>
                          <div className="information-inner">
                            <div className="tags-area-wrapper">
                              <div className="single-tag">
                        ...
                        <div className="rts-single-course course-list">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/15.jpg" alt="course" />
                          </a>
                          <div className="information-inner">
                            <div className="tags-area-wrapper">
                              <div className="single-tag">
                        ...
                        <div className="rts-single-course course-list">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/16.jpg" alt="course" />
                          </a>
                          <div className="information-inner">
                            <div className="tags-area-wrapper">
                              <div className="single-tag">
                        ...
                        <div className="rts-single-course course-list">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/17.jpg" alt="course" />
                          </a>
                          <div className="information-inner">
                            <div className="tags-area-wrapper">
                              <div className="single-tag">
                        ...
                        <div className="rts-single-course course-list">
                          <a href="single-course.html" className="thumbnail">
                            <Image width={500} height={300}    src="assets/images/course/18.jpg" alt="course" />
                          </a>
                          <div className="information-inner">
                            <div className="tags-area-wrapper">
                              <div className="single-tag">
