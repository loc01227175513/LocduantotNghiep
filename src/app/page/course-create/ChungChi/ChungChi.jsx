              ...
              <div className="relative group">
                ...
                >
                  <div className="relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
                    ...
                    {/* Selection Indicator */}
                    <div className={`absolute top-4 right-4 w-8 h-8 rounded-full bg-white/90 shadow-lg 
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                      <div className="flex items-center space-x-2 bg-white/90 backdrop-blur-sm p-2 rounded-lg shadow-lg">
                        <svg className="w-5 h-5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
