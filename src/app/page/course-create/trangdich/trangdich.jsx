    ...
    return (
        <div className="max-w-4xl p-6 mx-auto bg-white rounded-lg shadow-md">
            ...
            <p className="mb-6 text-gray-700">
                Your course landing page is crucial to your success on Udemy. If its done right, it can also help you gain visibility in search engines like Google.
            </p>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    {imageUrl && (
                        <div className="mt-2">
                            <Image width={500} height={300}    src={imageUrl} alt="Uploaded" className="w-full h-auto rounded-md shadow-sm" />
                        </div>
                    )}
                </div>
