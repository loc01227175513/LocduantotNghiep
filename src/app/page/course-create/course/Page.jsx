    ...
    <Fragment>
      <header className="sticky top-0 z-10 bg-gradient-to-r from-white to-blue-50 backdrop-blur-sm shadow-lg animate-float">
        <div className="container flex items-center justify-between px-6 py-4 mx-auto">
          ...
          <h1 className="text-[16px] text-center font-bold bg-gradient-to-r from-[#32ADE6] to-blue-600 bg-clip-text text-transparent hover:scale-105 transition-transform duration-300 cursor-default animate-gradient">
            Trang biên tập khóa học
          </h1>

          <div className="flex items-center space-x-5">
            <Link href={`/page/course-detail?id=${id}`}>
              <button className="px-4 py-2 rounded-lg border-2 text-[14px] border-[#32ADE6] text-[#32ADE6] bg-white hover:bg-[#32ADE6] hover:text-white transition-all duration-500 flex items-center space-x-2 shadow-sm hover:shadow-xl group">
