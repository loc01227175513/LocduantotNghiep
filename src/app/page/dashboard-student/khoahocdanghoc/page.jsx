        ...
        <div className="exrolled-course-wrapper-dashed">
          <ul className="nav nav-tabs" id="myTab" role="tablist">
            <div className="flex justify-between border-b border-gray-200">
              <button
                className={`flex-1 px-6 py-3 transition-all duration-300 whitespace-nowrap ${
                  page === 1
...
const Khoahocdanghoc = () => {
  ...
  return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lazada-style">
      {khoahocdanghoc1.map((item) => (
        <div key={item.id} className="col-span-1">
          <Link href={`/page/Study?id=${item.id}`}>
            <div className="single-course-style-three enroll-course">
              ...
              <div className="body-area">
                <div className="course-top">
                  ...
                  <div className="flex items-center">
                    <div className={`price ${item.giamgia > 0 ? 'line-through' : ''}`}>
              ...
              <div className="flex items-center justify-between teacher-stars">
