                ...
                {cartItems.map((item, index) => (
                  item.khoahocs.map((khoahoc, subIndex) => (
                    <tr key={`${index}-${subIndex}`} style={{ fontSize: '1.2em', height: '60px', marginBottom: '10px' }}>
                      ...
                      <td>
                        <Image width={500} height={300}    src={khoahoc.hinh} className="img-fluid rounded" alt={khoahoc.ten} style={{ maxWidth: '100px' }} />
                      </td>
                      <td>{khoahoc.ten}</td>
                      <td>
      ...
      <div className="voucher-list overflow-auto" style={{ maxHeight: '400px' }}>
        {vouchers.map(voucher => {
          ...
          return (
            <div
              key={voucher.id}
              className={`card mb-3 ${isSelected ? 'border-warning' : 'border-secondary'} shadow-sm p-3 mb-5 bg-body-tertiary rounded`}
            >
              <div className="card-body">
