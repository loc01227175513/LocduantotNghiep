...
export const AllGiangVien = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white mt-60">
            <div className="rts-bread-crumbarea-1 py-16 bg-blue-50">
                <div className="container mx-auto px-4">
                    <div className="text-center">
                        <h1 className="text-4xl font-bold mb-4">Người hướng dẫn</h1>
                        <div className="flex justify-center items-center gap-2">
                            <Link href="/" className="text-blue-600 hover:text-blue-800">Trang chủ</Link>
                            <span>›</span>
                            <span className="text-gray-600">Tất cả người hướng dẫn</span>
                        </div>
                    </div>
                </div>
            </div>
...
<motion.div
    key={instructor.id}
    variants={item}
    className="group relative p-[2px] rounded-xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-gradient-xy"
>
