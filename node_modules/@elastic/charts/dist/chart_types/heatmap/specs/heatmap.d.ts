...
/** @public */
export declare const heatmapBuildProps: import("../../../state/spec_factory").BuildProps<HeatmapSpec<any>, "chartType" | "specType", "data" | "timeZone" | "xAccessor" | "valueFormatter" | "valueAccessor" | "yAccessor" | "xSortPredicate" | "ySortPredicate" | "xScale" | "xAxisTitle" | "xAxisLabelName" | "xAxisLabelFormatter" | "yAxisTitle" | "yAxisLabelName" | "yAxisLabelFormatter", "name" | "highlightedData", "id" | "colorScale">;
/**
 * Adds heatmap spec to chart specs
 * @alpha
 */
export declare const Heatmap: <D extends BaseDatum = any>(props: SFProps<HeatmapSpec<D>, keyof (typeof heatmapBuildProps)["overrides"], keyof (typeof heatmapBuildProps)["defaults"], keyof (typeof heatmapBuildProps)["optionals"], keyof (typeof heatmapBuildProps)["requires"]>) => null;
/** @public */
