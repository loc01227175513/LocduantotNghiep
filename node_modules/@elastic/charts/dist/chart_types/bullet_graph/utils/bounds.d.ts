...
/** @public */
export type BoundsLimiter<T, U extends keyof BaseBoundsConfig<T>> = Assign<BaseBoundsConfig<never>, Required<Pick<BaseBoundsConfig<T>, U>>>;
/**
 * Allowed combination to define closed-ended/two-sided bounds
 * @public
 */
export type ClosedBoundsConfig<T> = BoundsLimiter<T, 'lt' | 'gt'> | BoundsLimiter<T, 'lt' | 'gte'> | BoundsLimiter<T, 'lte' | 'gt'> | BoundsLimiter<T, 'lte' | 'gte'>;
/**
 * Allowed combination to define open-ended/one-sided bounds
 * @public
 */
export type OpenBoundsConfig<T> = BoundsLimiter<T, 'lt'> | BoundsLimiter<T, 'lte'> | BoundsLimiter<T, 'gt'> | BoundsLimiter<T, 'gte'>;
/**
