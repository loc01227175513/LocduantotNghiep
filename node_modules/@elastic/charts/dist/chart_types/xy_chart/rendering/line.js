...
function renderLine(shift, dataSeries, xScale, yScale, panel, color, curve, hasY0Accessors, xScaleOffset, style, markSizeOptions, hasFit, pointStyleAccessor) {
    ...
    const { pointGeometries, indexedGeometryMap } = (0, points_1.renderPoints)(shift - xScaleOffset, dataSeries, xScale, yScale, panel, color, style.point, style.isolatedPoint, style.line.strokeWidth, hasY0Accessors, markSizeOptions, false, style.isolatedPoint.enabled, pointStyleAccessor);
    ...
    const lineGeometry = {
        ...
        shouldClip: hasFit,
        hasFit,
        minPointDistance: (0, types_1.isBandScale)(xScale) ? xScale.bandwidth : xScale.scale(xScale.domain[0] + xScale.minInterval),
    };
    return {
        lineGeometry,
        indexedGeometryMap,
