...
function getTooltipAndHighlightFromValue(seriesSpecs, axesSpecs, settings, projectedPointerPosition, orientedProjectedPointerPosition, chartRotation, hasSingleSeries, scales, matchingGeoms, seriesIdentifierDataSeriesMap, externalPointerEvent, tooltip) {
    var _a, _b;
    ...
    const values = matchingGeoms
        ...
        const formattedTooltip = (0, tooltip_1.formatTooltipValue)(indexedGeometry, spec, isHighlighted, hasSingleSeries, (0, series_1.isBandedSpec)(spec), yAxis);
        if (!header) {
    ...
    const tooltipSortFn = (_b = (_a = tooltip.sort) !== null && _a !== void 0 ? _a : settings.legendSort) !== null && _b !== void 0 ? _b : baseTooltipSortFn;
