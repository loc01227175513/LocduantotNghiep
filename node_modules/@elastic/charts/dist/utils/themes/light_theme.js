...
exports.LIGHT_THEME = {
    ...
    axes: {
        axisTitle: {
            ...
            fill: base_colors_1.LIGHT_BASE_COLORS.darkestShade,
        },
        axisPanelTitle: {
            visible: true,
            fontSize: 10,
    ...
    crosshair: {
        band: {
            visible: true,
            fill: base_colors_1.LIGHT_BASE_COLORS.lightestShade,
        },
        line: {
            visible: true,
            stroke: base_colors_1.LIGHT_BASE_COLORS.darkShade,
            strokeWidth: 1,
            dash: [4, 4],
        },
        crossLine: {
    ...
    background: {
        color: base_colors_1.LIGHT_BASE_COLORS.emptyShade,
        fallbackColor: base_colors_1.LIGHT_BASE_COLORS.emptyShade,
    },
    goal: {
        minFontSize: 8,
        maxFontSize: 64,
        ...
        targetLine: {
            stroke: base_colors_1.LIGHT_BASE_COLORS.darkestShade,
        },
        tickLine: {
            stroke: base_colors_1.LIGHT_BASE_COLORS.mediumShade,
        },
        progressLine: {
            stroke: base_colors_1.LIGHT_BASE_COLORS.darkestShade,
        },
    ...
    partition: {
        ...
        sectorLineWidth: 1.5,
        sectorLineStroke: base_colors_1.LIGHT_BASE_COLORS.emptyShade,
    },
    heatmap: {
        brushArea: {
            visible: true,
    ...
    metric: {
        ...
        textDarkColor: base_colors_1.LIGHT_BASE_COLORS.darkestShade,
    ...
    flamegraph: {
        ...
        scrollbarThumb: base_colors_1.LIGHT_BASE_COLORS.darkestShade,
        scrollbarTrack: base_colors_1.LIGHT_BASE_COLORS.lightShade,
    },
    highlighter: {
        point: {
            opacity: 0.5,
    ...
    rectAnnotation: {
        strokeWidth: 0,
        opacity: 0.25,
        fill: base_colors_1.LIGHT_BASE_COLORS.darkShade,
        stroke: base_colors_1.LIGHT_BASE_COLORS.darkShade,
    },
};
